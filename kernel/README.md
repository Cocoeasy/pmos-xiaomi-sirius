...
`sdm710-xiaomi-sirius.dts` now has this-unit reserved-memory, `uart12` at 0xA90000, USB2 gadget, and the PM660 charger / fuel gauge. SMB1355 is present on the phone but has no mainline driver. Still no display or Wi-Fi. Do not flash a boot image until USB actually enumerates on the phone.
